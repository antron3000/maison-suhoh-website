...
const EVENTS = [
  {
    id: "01",
    title: "GHANA\nFOOD MOVEMENT",
    subtitle: "A culinary celebration of Ghanaian culture, heritage, and the art of the table.",
    date: "APR 12, 2026",
    location: "ACCRA, GHANA",
    category: "PRIVATE DINNER",
    image: "/images/ghana-food-01.jpg",
    hero: "/images/ghana-food-05.jpg",
    stats: [
    ...
    clients: ["MAISON SUKOH", "GHANA FOOD MOVEMENT"],
  },
  {
    id: "02",
    title: "LUMIÈRE\nLAUNCH",
