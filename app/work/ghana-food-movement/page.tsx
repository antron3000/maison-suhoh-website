    ...
    <>
      ...
      <main className="pt-20 pb-16 px-6 bg-background min-h-screen">
        ...
        <div className="flex items-end justify-between mb-10 max-w-6xl mx-auto">
          <div>
            <p className="text-[10px] tracking-[0.1em] text-foreground/50 mb-1">006</p>
            <h1 className="text-2xl tracking-[-0.04em]">GHANA FOOD MOVEMENT</h1>
          </div>
